...
Maven build, driving the legacy web UI's htmlform mastercards/flowsheets and core patient
registration. See [`e2e/README.md`](e2e/README.md) for setup and run instructions, how the suite
is structured, and a per-htmlform coverage table. See
[`docs/program-eligibility-rules.md`](docs/program-eligibility-rules.md) for the underlying
program/mastercard eligibility rules the tests exercise.
