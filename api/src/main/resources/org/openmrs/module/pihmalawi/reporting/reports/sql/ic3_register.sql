...
-- Asthma Meds
CALL getCodedObsWithValuesFromEncounterBeforeDate(CONCAT(@currentDrugsUsedConceptId,',',@chronicLungDiseaseTreatmentConceptId), CONCAT(@CC_F,',',@A_F), CONCAT(@inhaledBetaAgonistsConceptId,',',@inhaledBetaAgonistOtherConceptId), @reportEndDate, 'last', 'inhaledBAgonist');
